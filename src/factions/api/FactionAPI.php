...
class FactionAPI
{
    ...
    /**
     * TODO: Получать не список участников по ид фракции, а получать списки игроков по рангам
     * @deprecated
     ...
     */
    public static function getFactionMembers(string $factionId): array
    {
        $members = [];
    ...
    /**
     * Return CustomPlayer or make new CustomPlayer
     * @param $name
     * @return CustomPlayer
     */
